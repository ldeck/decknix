...
(declare-function decknix--agent-conversation-key-for-session "ext:decknix-agent-shell-main")
...
(declare-function decknix--agent-latest-session-id-for-conv-key "ext:decknix-agent-shell-main")
